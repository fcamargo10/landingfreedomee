...
<head>
    ...
    <title>FredomeE - #made4better</title>
    <meta name="description" content="FreedomeE social network.">
            ...
            <div class="col-12 my-auto">
                <div class="row main text-center">
                    <div class="col-sm-12 col-md-5">
                        <img src="/assets/img/logo.png" class="mx-auto d-block img-fluid">
                        <img src="/assets/img/globe.png" class="mx-auto d-block img-fluid">
                        ...
                        <div style="max-width: 500px; margin:50px auto auto auto;">
                            ...
                            <form action="">
                                <div class="form-group">
                                    <input type="text" class="form-control bgroxo" style="max-width: 460px;" placeholder="nome:">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control mt-2 bgroxo" style="max-width: 460px;" placeholder="email:">
                                </div>
